    			...
    			<div class="col-4" style="margin-top: 3%">
    				<div class="row justify-content-center">
    					<div class="col-12">
    						...
    						<p>Es el reporte detallado de la información que se encuentra en las diferentes Juntas de Conciliación y Arbitraje de las Entidades Federativas.</p>
    					</div>
    				</div>
    			</div>
    			<div class="col-4" style="margin-top: 3%">
    				<div class="row">
    					<div class="col-12">
    						...
    						<p>Es el reporte detallado de la información que se encuentra en los diferentes juzgados correspondientes al ámbito penal.</p>
    					</div>
    				</div>
    			</div>
    			<div class="col-4" style="margin-top: 3%">
    				<div class="row">
    					<div class="col-12">
    						<h5>BURÓ LEGAL</h5><br>
    						<p>Es el reporte detallado de la información que se encuentra en el sistema legal del país, ya sea de carácter Penal, Laboral, Civil y/o Mercantil.</p>
    					</div>
    				</div>
     			</div>
     			<div class="col-12" style="margin-top: 3%">
     				<p>Todos estos reportes o información adicional tienen por objetivo ayudar a evitar que ingresen a tu empresa personas que tengan antecedentes y/o problemas legales y con ello posibles pérdidas económicas o gastos para tu empresa.</p>
     			</div>
